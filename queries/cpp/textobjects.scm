...
((parameter_list
  ","  @parameter.outer._start . (optional_parameter_declaration) @parameter.inner @parameter.outer._end)
 )
((parameter_list
  . (optional_parameter_declaration) @parameter.inner @parameter.outer._start . ","?  @parameter.outer._end)
 )

((initializer_list
  ","  @parameter.outer._start . (_) @parameter.inner @parameter.outer._end  @_end)
 )
((initializer_list
  . (_) @parameter.inner @parameter.outer._start . ","?  @parameter.outer._end)
 )
