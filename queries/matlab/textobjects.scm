...
((arguments ","?  @parameter.outer._start . (_) @parameter.inner @parameter.outer._end . )
 )
((arguments (_) @parameter.inner @parameter.outer._start . ","  @parameter.outer._end)
 )
...
((function_arguments ","?  @parameter.outer._start . (_) @parameter.inner @parameter.outer._end . )
 )
((function_arguments (_) @parameter.inner @parameter.outer._start . ","  @parameter.outer._end)
 )

((multioutput_variable ","?  @parameter.outer._start . (_) @parameter.inner @parameter.outer._end . )
 )
...
((validation_functions ","?  @parameter.outer._start . (_) @parameter.inner @parameter.outer._end . )
 )
((validation_functions (_) @parameter.inner @parameter.outer._start . ","  @parameter.outer._end)
 )

((dimensions ","?  @parameter.outer._start . (_) @parameter.inner @parameter.outer._end . )
 )
((dimensions (_) @parameter.inner @parameter.outer._start . ","  @parameter.outer._end)
 )

((attributes ","?  @parameter.outer._start . (_) @parameter.inner @parameter.outer._end . )
 )
((attributes (_) @parameter.inner @parameter.outer._start . ","  @parameter.outer._end)
 )
